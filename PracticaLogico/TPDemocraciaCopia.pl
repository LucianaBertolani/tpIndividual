...
% SE PODRIA HACER LISTA PARA LAS PROVINCIAS DONDE SE POSTULA?!
...
postulaProvincia(Partido,Provincia,CantHabitantes) || postulaProvincia2(Partido,Provincia) && cantidadHabitantes(Provincia,Cantidad)
